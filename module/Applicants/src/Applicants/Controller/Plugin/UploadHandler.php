...
class UploadHandler extends AbstractPlugin
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $file_base_path=null, $pkey=0, $doc_pkey=0) {
        
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            //'upload_url' => $this->get_full_url().'/files/',
            'upload_dir' => $file_base_path,
            'upload_url' => $file_base_path,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function post($print_response = true) {
        ...
        //Set Pkey in files  upload
        $files[] = array('pkey'=>$this->options['pkey']);
        $files[] = array('doc_pkey'=>$this->options['doc_pkey']);
